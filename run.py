'''
    - 필요 패키지 설치
    - pip install tensorflow transformers flask flask-socketio
...
def cTos_create_sentence( data ):
    ...
    while len(input_vectors) < 25:
        ...
        answer_txts.append( tokenizer.decode( [token_id] ) )

    emit('sToc_create_sentence', { 'word': ' '.join(answer_txts)} )
